...
public class Waitutils {
    ...
    public static void WaitToBeVisible(WebDriver webDriver, String locatorType, String locatorValue, Integer seconds) {
    ...
    public static void WaitToExist(WebDriver webDriver, String locatorType, String locatorValue, int seconds) {
        WebDriverWait webDriverWait = new WebDriverWait(webDriver, Duration.ofSeconds(seconds));
